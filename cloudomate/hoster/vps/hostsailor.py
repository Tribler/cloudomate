...
class HostSailor(SolusvmHoster):
    CART_URL = 'https://clients.hostsailor.com/cart.php?a=view'
    ...
    def get_clientarea_url():
        return 'https://panel.linevast.de/clientarea.php'  # TODO

    @staticmethod
    def get_email_url():
        return 'https://panel.linevast.de/viewemail.php'  # + ?id=123456 # TODO
